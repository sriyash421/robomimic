...
class DiTPolicyConfig(BaseConfig):
    ALGO_NAME = "dit_policy"
    ...
    def train_config(self):
        ...
        """
        super(DiTPolicyConfig, self).train_config()
        
        # disable next_obs loading from hdf5
        self.train.hdf5_load_next_obs = False

        # set compatible data loading parameters
        self.train.seq_length = 1024 # should match self.algo.horizon.prediction_horizon
        self.train.frame_stack = 1 # should match self.algo.horizon.observation_horizon
    ...
    def algo_config(self):
        ...
        self.algo.transformer.context_length = 1024                   # length of (s, a) seqeunces to feed to transformer - should usually match train.frame_stack
